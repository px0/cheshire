...
(defn parse-string
  ...
  ([^String string key-fn array-coerce-fn map-coerce-fn]
   (when string
     (parse/parse
      (.createParser ^JsonFactory (or factory/*json-factory*
                                      factory/json-factory)
                     ^Reader (StringReader. string))
      key-fn nil array-coerce-fn map-coerce-fn))))
...
(defn parse-stream
  ...
  ([^BufferedReader rdr key-fn array-coerce-fn map-coerce-fn]
   (when rdr
     (parse/parse
      (.createParser ^JsonFactory (or factory/*json-factory*
                                      factory/json-factory)
...
(defn parse-smile
  ...
  ([^bytes bytes key-fn array-coerce-fn map-coerce-fn]
   (when bytes
     (parse/parse
...
(defn- parsed-seq*
  ...
  [^JsonParser parser key-fn array-coerce-fn map-coerce-fn]
  (lazy-seq
   (let [elem (parse/parse-strict parser key-fn eof array-coerce-fn map-coerce-fn)]
     (when-not (identical? elem eof)
       (cons elem (parsed-seq* parser key-fn array-coerce-fn map-coerce-fn))))))
...
(defn parsed-seq
  ...
  ([^BufferedReader reader key-fn array-coerce-fn map-coerce-fn]
   (when reader
     (parsed-seq* (.createParser ^JsonFactory
                                 (or factory/*json-factory*
                                     factory/json-factory)
                                 ^Reader reader)
                  key-fn array-coerce-fn map-coerce-fn))))
